...
const CommonProvisionOutputV1Schema = z.object({
    ...
    dataDiskRebootRequired: z.boolean().optional().describe("Whether a reboot is required before mounting data disk to ensure stable device detection (e.g., AWS with instance stores)"),
}).passthrough()
