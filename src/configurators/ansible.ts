            ...
            all: {
                hosts: {
                    [this.args.instanceName]: {
                        ...
                        sunshine_max_bitrate_kbps: this.args.configurationInput.sunshine?.maxBitrateKbps,

                        sunshine_autoheal_enable: this.args.configurationInput.sunshine?.autoheal?.enable,
